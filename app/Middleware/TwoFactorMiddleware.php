...
{
    public function __construct(private TwoFactorAuthModel $two_factor_auth_model) {}
    ...
    public function process(Request $request, RequestHandler $handler): ResponseInterface
    {
        ...
        $has2FAEnabled = $this->two_factor_auth_model->isEnabled($userId); // Replace with: $twoFactorModel->isEnabled($userId);
