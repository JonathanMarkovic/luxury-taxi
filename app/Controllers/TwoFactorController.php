...
{
    public function __construct(ContainerInterface $container, private TwoFactorAuthModel $two_factor_auth_model, private UserModel $user_model)
    {
    ...
    public function showSetup(Request $request, Response $response): Response
    {
        ...
        $tfa = new TFA($qrCode, 'Solaf Performance');
    ...
    public function verifyAndEnable(Request $request, Response $response): Response
    {
        ...
        $qrCode = new BaconQrCodeProvider(4, '#ffffff', '#000000', 'svg');
        $tfa = new TFA($qrCode, 'Solaf Performace');
        ...
        // $twoFactorModel = $this->container->get(TwoFactorAuthModel::class);
        $this->two_factor_auth_model->create($userId, $secret);
        $this->two_factor_auth_model->enable($userId);
    ...
    public function verify(Request $request, Response $response): Response
    {
        ...
        $twoFactorModel = $this->container->get(TwoFactorAuthModel::class);
        $secret = $twoFactorModel->getSecret($userId); // Replace with your implementation
    ...
    public function disable(Request $request, Response $response): Response
    {
        ...
        //todo check this
        $validUser = $this->user_model->verifyCredentials($userEmail, $password);
